...
\nbkeys{
  ...
  top rule/.style={
    append after command={
      \pgfextra{\draw[#1] (\tikzlastnode.north west) -- (\tikzlastnode.north east);}
    },
  },
  bottom rule/.style={
    append after command={
      \pgfextra{\draw[#1] (\tikzlastnode.south west) -- (\tikzlastnode.south east);}
    },
  },
  draw/.style={
  ...
  columns/.style 2 opt={draw}{
    elem={[#1]{
      ...
      \foreach \field/\cols in {#2} {
        ...
        \notfirst{
          \draw ($(@@.north west)+(west:.5\pgflinewidth)+(down:\columnDivider)$)
...
\pgfkeys{
  /notebook/fill crosses/.style={
    fill elem={
      pattern color=gray,pattern={Crosses[distance=5mm]}
    }
  }
}
